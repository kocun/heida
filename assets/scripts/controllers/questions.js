...
angular.module('heidaApp')
  .controller('QuestionCtrl', function($scope, $http, Restangular) {

    Restangular.all('/api/question?limit=-1').getList().then(function(questions) {
      $scope.questions = questions;
    });

  }).controller('QuestionNewCtrl', function($scope, $http, Restangular, $state, $stateParams) {
